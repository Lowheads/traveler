...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<form role="form" action="/buddt/amend" method="post">
...
<%-- 			<!-- p.319 -->
			...
			<input type='hidden' name='keyword' value='<c:out value="${cri.keyword }"/>'> --%>
					...
					<div class="form-group">
					 ...
					 value='<c:out value="${board.paydate }"/>' readonly="readonly"> --%>
					...
					<div class="form-group">
					  <label>sch_no</label> <input class="form-control" name='sch_no'
					...
					<div class="form-group">
					  <label>bud_cate</label> 
					  <input class="form-control" name='bud_cate'
